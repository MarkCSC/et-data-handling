...
def main():
    ...
    # =====================================================
    # 3. read all image in opencv one by one and process it
    # =====================================================
        ...
        while not file_queue.empty() and not close_window:
            ...
            while True:
                ...
                if key == 13: # Enter key
                    ...
                    # not write to file if -i argument
                    if not args.ignore:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--image_dir", 
                        default=os.path.join(os.getcwd(), 'image'), 
                        help="directory for importing original image")
    parser.add_argument("--snip_dir",
                        default=os.path.join(os.getcwd(), 'snip'),
